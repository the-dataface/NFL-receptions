      ...
      var margin = {top: 50, right:margin_right, bottom: 100, left: 50};
      ...
      d3.csv("top20_players_FINAL.csv", rowConverter, function(data) {
        ...
        */
        ...
        var xScale = d3.scaleLinear()
                        .domain([0,
                          d3.max(dataset, function(d) {return d.game;})
                        ])
                        .range([0, w]);
        ...
        var yScale = d3.scaleLinear()
                        .domain([0,
                          d3.max(dataset, function(d) {return d.catches;})
                        ])
                        .range([h, 0]);
        ...
        var line = d3.line()
                     ...
                     .y(function(d) { return yScale(d.catches);})
           ...
           var create_line_and_label = function(data_set, name, game, catches, seasons_played) {
             ...
             svg.append("rect")
              ...
              svg.append("text")
                 ...
                 .filter(function() {return small_screen})
                 .attr("x", xScale(game))
